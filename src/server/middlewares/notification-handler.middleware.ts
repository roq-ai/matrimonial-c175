...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'profile.create': {
    roles: ['admin-user', 'profile-manager', 'matchmaker', 'customer-support'],
    key: 'profile-created',
    tenantPath: ['company', 'user', 'profile'],
    userPath: [],
  },
  'match.create': {
    roles: ['admin-user', 'profile-manager', 'matchmaker', 'customer-support'],
    key: 'match-suggested',
    tenantPath: ['company', 'user', 'profile', 'match'],
    userPath: [],
  },
  'query.create': {
    roles: ['admin-user', 'customer-support'],
    key: 'query-created',
    tenantPath: ['company', 'user', 'query'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['admin-user', 'profile-manager', 'matchmaker', 'customer-support'];
