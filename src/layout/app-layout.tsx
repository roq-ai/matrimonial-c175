...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['admin-user', 'profile-manager', 'matchmaker', 'customer-support'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Matches', path: '/matches', entity: 'match', service: AccessServiceEnum.PROJECT, icon: FiCheckSquare },
    { name: 'Profiles', path: '/profiles', entity: 'profile', service: AccessServiceEnum.PROJECT, icon: FiUserCheck },
    { name: 'Queries', path: '/queries', entity: 'query', service: AccessServiceEnum.PROJECT, icon: FiSearch },
    {
      name: 'Suggestions',
      path: '/suggestions',
      entity: 'suggestion',
