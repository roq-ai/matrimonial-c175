  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Matrimonial - Your Ultimate Online Matrimonial Software, Bridging Hearts and Souls Together Effortlessly."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1582470584920-7946b028fdea?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxtYXRyaW1vbnl8ZW58MHx8fHwxNjkyNjI3ODkwfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@andyjh07?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Andy Holmes`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Matrimonial - Your Ultimate Online Matrimonial Software, Bridging Hearts and Souls Together Effortlessly.`}
            </Text>
            <Box
            ...
            >
              <Stack direction="column" spacing={6}>
                <Card userTypeName="Admin User" type="admin-user" />
